...
seo:
  title: Telegram Bot
  description: Add EliteMoney transactions directly from Telegram - via commands, free-form text, or receipt photo recognition. Includes account linking guide.
---
