...
seo:
  title: AI Chat
  description: EliteMoney AI chat architecture, tools, prompts, model recommendations.
---

## Overview

EliteMoney ships a local AI assistant powered by [Ollama](https://ollama.com) and [@tanstack/ai](https://tanstack.com/ai). The chat lives in a slide-over panel (`AiChatPanel.vue`) and exposes ~24 tools that wrap Pinia store mutations and queries. No data leaves the user's machine.
