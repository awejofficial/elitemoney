...
seo:
  title: Performance
  description: How EliteMoney keeps cold start fast - cache-first paint, lazy PowerSync/swiper/echarts chunks, icon bundling, narrowed SW precache, and performance marks.
---
