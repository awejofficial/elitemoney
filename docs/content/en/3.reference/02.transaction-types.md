...
seo:
  title: Transaction Types
  description: EliteMoney transaction types reference - Expense, Income, Transfer, and Adjustment - with detection logic, type change behavior, and statistics output.
---

## Overview

EliteMoney supports three transaction types and one special category:
