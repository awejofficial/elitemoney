...
seo:
  title: Architecture
  description: EliteMoney architecture deep-dive - app initialization, project structure, Pinia store pattern, Supabase Auth, PowerSync offline-first, and PWA setup.
---
...
```
app/                        # @elitemoney/app - Nuxt source, Supabase config, PowerSync config
...
docs/                       # @elitemoney/docs - documentation site
