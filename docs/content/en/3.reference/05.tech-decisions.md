...
seo:
  title: Technical Decisions
  description: Technical decisions in EliteMoney and their rationale - PowerSync offline-first, optimistic UI, client-generated UUIDs, hard sign-out navigation, arithmetic parser, and cascade deletes.
---
