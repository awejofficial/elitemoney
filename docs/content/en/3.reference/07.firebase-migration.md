...
seo:
  title: What Changed Since Firebase
  description: Side-by-side comparison of legacy v6 (Firebase) and the current Supabase Postgres + PowerSync app - backend, performance, security, tests, and architecture.
---

> **Two eras.** The backend evolved from **Firebase** (v6 - Firebase Realtime Database + Firebase Auth) to the **current** stack: **Supabase Postgres + PowerSync** (offline-first) + **Supabase Auth**.
>
...
Side-by-side comparison of what the app looks like on the legacy architecture (v6, Firebase) vs the current Supabase + PowerSync app.
