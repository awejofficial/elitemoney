...
seo:
  title: AI Skills
  description: Claude Code skills for EliteMoney - security review checklist, TDD workflow with Vitest, Nuxt 4 SPA patterns, and Playwright E2E testing.
---
...
Nuxt 4 patterns adapted for EliteMoney's SPA mode.
