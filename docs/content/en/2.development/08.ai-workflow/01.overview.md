---
title: Overview
description: How Claude Code is configured for the EliteMoney project, agents and skills.
navigation:
  icon: i-lucide-bot
seo:
...
- `/understand`, analyzes the full codebase and produces an interactive knowledge graph
