---
title: Installation
description: Get started with EliteMoney - clone, configure env vars, start the local backend, and run the dev server.
navigation:
  icon: i-lucide-download
seo:
  title: Installation
  description: How to install and run EliteMoney locally with Supabase and PowerSync.
---
...
This creates a `powersync_role` with replication privileges and a `powersync` publication scoped to the EliteMoney tables.
