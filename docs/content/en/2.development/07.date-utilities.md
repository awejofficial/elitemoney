...
seo:
  title: Date Utilities
  description: Date utilities in EliteMoney - type-safe period handling, interval computation, date range formatting, and transaction bucketing with binary search.
---
