...
seo:
  title: Theme
  description: Customize EliteMoney's appearance - choose light, dark, or system color mode, select from 20+ primary colors, set neutral palette and border radius.
---

Personalize EliteMoney's appearance - choose colors, dark mode, and corner roundness to match your style. All settings apply instantly without a page reload.
...
EliteMoney supports three color modes:
