---
title: Introduction
description: EliteMoney - a free open-source app for personal finance management.
navigation:
  icon: i-lucide-house
seo:
  title: Introduction
...
::card-group
  ...
  target: _blank
  title: Try Demo
  to: https://elitemoney.vercel.app
  ---
  ...
  title: Setup Guide
  to: /en/development/installation
  ---
  Local development and architecture guide
  :::
::
...
On first sign-in, EliteMoney guides you through a step-by-step setup. Each step shows a description and a single action button:
...
EliteMoney supports keyboard shortcuts for quick access to core features (desktop only):
...
- [Install the App](/en/guide/installation) - add EliteMoney to your device as a PWA
