...
seo:
  title: Архитектура
  description: Архитектура EliteMoney: инициализация приложения, паттерн хранилищ, Supabase Auth, офлайн-first через PowerSync и настройка PWA.
---
...
```
app/                        # @elitemoney/app - Nuxt, конфиг Supabase, конфиг PowerSync
...
docs/                       # @elitemoney/docs - сайт документации
