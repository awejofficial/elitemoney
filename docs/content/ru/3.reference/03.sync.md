...
seo:
  title: Синхронизация
  description: Как работает синхронизация данных в EliteMoney через PowerSync - локальная SQLite как источник истины, потоки синхронизации, очередь загрузки, объединение изменений и подавление эха.
---
