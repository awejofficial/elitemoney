...
seo:
  title: Что изменилось со времён Firebase
  description: Подробное сравнение EliteMoney v6 (Firebase) и текущего приложения на Supabase Postgres + PowerSync - изменения бэкенда, производительность, безопасность, тесты, рефакторинг и архитектура.
---

> **Две эпохи.** Бэкенд EliteMoney прошёл путь от **Firebase** (v6 - Firebase Realtime Database + Firebase Auth) к **текущему** стеку: **Supabase Postgres + PowerSync** (offline-first) + **Supabase Auth**.
>
