...
seo:
  title: AI Chat
  description: Архитектура AI чата EliteMoney, tools, промпты, рекомендации моделей.
---

## Обзор

В EliteMoney встроен локальный AI ассистент на [Ollama](https://ollama.com) и [@tanstack/ai](https://tanstack.com/ai). Чат живёт в slide-over панели (`AiChatPanel.vue`) и предоставляет ~24 tool'а, оборачивающих мутации и запросы Pinia-сторов. Данные не покидают машину пользователя.
