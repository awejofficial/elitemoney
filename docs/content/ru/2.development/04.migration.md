...
description: Исторический обзор миграции бэкенда - с Firebase на Supabase + PowerSync.
navigation:
  icon: i-lucide-database
seo:
  title: История миграций данных
  description: Историческая справка о миграции бэкенда - из Firebase Realtime Database на Supabase Postgres с PowerSync.
---

Бэкенд приложения был мигрирован с **Firebase Realtime Database** на **Supabase Postgres + PowerSync** (offline-first синхронизация) с **Supabase Auth (email/password)**. На этой странице описана и сама миграция, и скрипт, который импортирует Firebase-экспорт в Supabase.

Архитектура Firebase сохранена в качестве исторической справки.
