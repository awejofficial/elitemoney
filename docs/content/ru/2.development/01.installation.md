---
title: Установка
description: Начало работы с EliteMoney - клонирование, настройка переменных окружения, запуск локального бэкенда и dev-сервера.
navigation:
  icon: i-lucide-download
seo:
  title: Установка
  description: Как установить и запустить EliteMoney локально с Supabase и PowerSync.
---
...
Эта команда создаёт роль `powersync_role` с правами репликации и публикацию `powersync` для таблиц EliteMoney.
