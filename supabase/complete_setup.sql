-- =========================================================================
-- PEIT: COMPLETE DATABASE SETUP (Run once in Supabase SQL Editor)
-- =========================================================================
...
-- 2. Default Categories & Signup Triggers
...
-- Web Push subscriptions (PRD §6.5/§6.6 push notifications). Run once in
-- Supabase Dashboard → SQL Editor, after 0001 and 0002.
