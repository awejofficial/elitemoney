export default {
  ...
  categories: {
    presets: {
      modalTitle: 'Готовые наборы категорий',
      choosePack: 'Выберите набор категорий',
      previewTitle: 'Категории в наборе',
      dbNotice: 'Все категории сохраняются напрямую в базу данных. Их можно редактировать или удалять в любой момент.',
      addSelected: 'Добавить категории в базу',
      importedSuccess: 'Категории успешно сохранены в базу данных!',
      emptyTitle: 'Начните с готового набора',
      emptySubtitle: 'Выберите готовый набор для быстрого старта или создайте свои категории с нуля.',
      previewAndAdd: 'Просмотр и добавление',
      orCreateCustom: 'Хотите создать категорию вручную?',
      essentials: {
        name: 'Базовый (Все необходимое)',
        desc: 'Еда, жилье, транспорт, покупки, подписки, здоровье и доходы.',
      },
      student: {
        name: 'Студенческий / Общежитие',
        desc: 'Столовая, кафе, аренда/общежитие, книги, связь и карманные деньги.',
      },
      freelance: {
        name: 'Фриланс / Удаленка',
        desc: 'Сервисы и ПО, техника, коворкинг, интернет, встречи и счета клиентам.',
      },
      names: {
        food: 'Еда и питание',
        groceries: 'Продукты',
        mess: 'Столовая / Обеды',
        cafes: 'Кафе и перекусы',
        delivery: 'Доставка еды',
        restaurants: 'Рестораны',
        housing: 'Жилье и коммунальные',
        rent: 'Аренда / Ипотека',
        electricity: 'Свет и газ',
        internet: 'Интернет и связь',
        water: 'Водоснабжение',
        maintenance: 'Ремонт и быт',
        transport: 'Транспорт',
        fuel: 'Топливо / Бензин',
        transit: 'Метро и автобусы',
        cab: 'Такси',
        parking: 'Парковка и проезд',
        shopping: 'Покупки и одежда',
        clothes: 'Одежда и обувь',
        electronics: 'Электроника и гаджеты',
        personalCare: 'Уход и косметика',
        gifts: 'Подарки и праздники',
        entertainment: 'Развлечения и отдых',
        subscriptions: 'Подписки и медиа',
        movies: 'Кино и театры',
        gaming: 'Игры и хобби',
        travel: 'Путешествия и поездки',
        health: 'Здоровье и медицина',
        medicines: 'Аптека и лекарства',
        doctor: 'Врачи и клиники',
        fitness: 'Спорт и фитнес',
        education: 'Образование и книги',
        books: 'Книги и учебники',
        courses: 'Курсы и обучение',
        income: 'Доходы и поступления',
        salary: 'Зарплата',
        freelance: 'Фриланс и подработка',
        investments: 'Инвестиции и дивиденды',
        refunds: 'Возвраты и кэшбэк',
        canteen: 'Буфет и уличная еда',
        hostelRent: 'Аренда / Общежитие',
        mobileData: 'Мобильная связь',
        busPass: 'Проездной билет',
        pocketMoney: 'Карманные деньги',
        saasSoftware: 'ПО и сервисы',
        hardware: 'Техника и оборудование',
        coworking: 'Коворкинг и кофе',
        fiberInternet: 'Оптоволоконный интернет',
        clientMeetings: 'Встречи с клиентами',
        clientInvoices: 'Оплата по счетам',
        projectBonuses: 'Бонусы и роялти',
      },
    },
    actions: {
  ...
  stat: {
    ...
    title: 'Статистика',
    noDataInRange: 'Нет транзакций за выбранный период',
    resetRange: 'Сбросить диапазон дат',
  },
  ...
  tabs: {
    title: 'Ежедневные счета и столовая',
    subtitle: 'Учет питания, подписок, молока и доставок',
    new: 'Новый счет',
    edit: 'Редактировать счет',
    deleteConfirm: 'Удалить этот счет и его историю?',
    emptyTitle: 'Нет счетов',
    emptyDesc: 'Ведите учет столовой, доставок или подписок в один клик.',
    monthlyEstimate: 'Общая сумма к оплате за месяц',
    unitPrice: 'Цена за единицу',
    defaultUnits: 'Единиц в день по умолчанию',
    slots: 'Смены / Приемы пищи',
    todayTally: 'Сегодня',
    monthDues: 'Счет за месяц',
    settleMonth: 'Оплатить счет за месяц',
    shareSlip: 'Поделиться в WhatsApp',
    slipCopied: 'Счет скопирован в буфер обмена!',
    settled: 'Оплачено',
    unsettled: 'К оплате',
    attendedDays: 'Дней посещено',
    totalConsumed: 'Всего получено',
    skippedUnits: 'Пропущено',
    savedAmount: 'Сэкономлено',
    history: 'Журнал посещений',
    pastSettlements: 'История оплат',
    paid: 'Оплачено',
    attended: 'Посещено',
    days: 'дн.',
    skipped: 'Пропущено',
    saved: 'Сэкономлено',
    monthSettled: 'Счет за месяц отмечен как оплаченный',
    today: 'Сегодня',
    offSkipped: 'Выходной / Пропуск',
    totalPayable: 'Итого к оплате',
    payFromWallet: 'Оплатить из кошелька',
    expenseCategory: 'Категория расхода',
    confirmSettle: 'Подтвердить оплату и записать расход',
    thisMonth: 'в этом месяце',
    activeSubs: 'активно',
    choosePreset: 'Или выберите быстрый шаблон',
    presetMess: 'Столовая (Обед и ужин)',
    presetMilk: 'Доставка молока',
    presetWater: 'Питьевая вода',
    presetMessLabel: 'Столовая (Обед и ужин)',
    presetMilkLabel: 'Доставка молока',
    presetWaterLabel: 'Бутыли воды',
    presetCustomLabel: 'Свой шаблон',
    unitTiffin: 'порция',
    unitLiter: 'литр',
    unitCan: 'бутыль',
    unitGeneric: 'ед.',
    slotLunch: 'Обед',
    slotDinner: 'Ужин',
    tabName: 'Название счета',
    tabNamePlaceholder: 'например, Столовая №1, Доставка молока',
    unitLabel: 'Единица измерения',
    unitLabelPlaceholder: 'например, порция, литр, бутыль',
    separateSlots: 'Несколько смен в день',
    separateSlotsDesc: 'Раздельный учет: Обед и Ужин или Утро и Вечер',
    slotName: 'Смена',
    addSlot: 'Добавить смену',
    presets: {
      custom: 'Свой счет',
      mess: 'Столовая / Обед и ужин',
      milk: 'Доставка молока (литры)',
      water: 'Питьевая вода (бутыли)',
    },
  },
  ...
  wallets: {
    ...
    title: 'Кошельки',
    noMatchFilter: 'Нет кошельков, подходящих под фильтр',
  ...
  people: {
    ...
    phonePlaceholder: 'Телефон или контактные данные',
    descPlaceholder: 'например, Счет в кафе, часть за аренду',
    repaymentDate: 'Ожидаемая дата возврата',
    dueLabel: 'Срок',
    paidSoFar: 'Выплачено',
    ofTotal: 'из',
    partialPay: 'Записать платеж',
    originalAmount: 'Исходная сумма',
    remaining: 'Остаток',
    payAmount: 'Сумма платежа',
    autoSettled: 'Остаток станет 0 — запись будет автоматически отмечена закрытой',
    confirmPay: 'Подтвердить платеж',
    settleAllConfirm: 'Отметить все открытые долги с этим человеком закрытыми?',
    search: 'Поиск людей...',
  ...
  recurring: {
    ...
    ruleNamePlaceholder: 'например, Подписка Netflix, Аренда квартиры',
    notePlaceholder: 'например, Семейный тариф, Зарплатный счет',
