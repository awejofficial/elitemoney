export default {
  ...
  people: {
    ...
    notes: 'Телефон или заметка (необязательно)',
    search: 'Поиск людей...',
  ...
  recurring: {
    ...
    deleteConfirm: 'Вы уверены, что хотите удалить это правило?',
  ...
  notifications: {
    ...
    desc: 'Получайте напоминания даже когда приложение закрыто.',
    enable: 'Включить уведомления',
    enabled: 'Активно на этом устройстве',
    blocked: 'Заблокировано в настройках браузера',
    dailyReminder: 'Ежедневное напоминание',
    dailyReminderDesc: 'Напоминать записать сегодняшние расходы и доходы',
    time: 'Время напоминания',
    lendingAlerts: 'Напоминания о долгах',
    lendingAlertsDesc: 'Оповещать за 1 день до срока возврата долга',
    recurringAlerts: 'Напоминания о подписках',
    recurringAlertsDesc: 'Оповещать перед списанием регулярных платежей',
