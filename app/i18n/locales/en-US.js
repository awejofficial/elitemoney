export default {
  ...
  categories: {
    presets: {
      modalTitle: 'Starter Category Packs',
      choosePack: 'Choose a Starter Pack',
      previewTitle: 'Categories in Pack',
      dbNotice: 'All categories are saved directly to your database and can be edited or deleted anytime.',
      addSelected: 'Add Categories to Database',
      importedSuccess: 'Categories successfully added to database!',
      alreadyAdded: 'Already in Database',
      alreadyAddedBadge: 'Already Added',
      alreadyAddedTooltip: 'This category already exists in your database',
      skipExisting: 'Skip existing categories',
      emptyTitle: 'Start With Curated Categories',
      emptySubtitle: 'Choose a starter pack to instantly set up your tracking, or create custom categories from scratch.',
      previewAndAdd: 'Preview & Add',
      orCreateCustom: 'Prefer starting from scratch?',
      essentials: {
        name: 'Comprehensive Essentials',
        desc: 'Food, housing, transport, shopping, subscriptions, health, and income.',
      },
      student: {
        name: 'Student & Campus',
        desc: 'Daily mess/tiffin, canteen, hostel rent, books, mobile data, and allowance.',
      },
      freelance: {
        name: 'Freelancer & Remote',
        desc: 'Software SaaS, hardware, coworking, internet, client dinners, and invoices.',
      },
      names: {
        food: 'Food & Dining',
        groceries: 'Groceries',
        ...
        canteen: 'Canteen & Street Food',
        hostelRent: 'Hostel / PG Rent',
        mobileData: 'Mobile Recharge',
        busPass: 'Bus & Metro Pass',
        pocketMoney: 'Pocket Money & Allowance',
        saasSoftware: 'Software & SaaS Tools',
        hardware: 'Hardware & Gear',
        coworking: 'Coworking & Cafes',
        fiberInternet: 'Fiber Internet',
        clientMeetings: 'Client Dinners & Meetings',
        clientInvoices: 'Client Invoices',
        projectBonuses: 'Bonuses & Royalties',
      },
    },
    actions: {
  ...
  stat: {
    ...
    title: 'Dashboard',
    noDataInRange: 'No transactions found for the selected date range',
    resetRange: 'Reset date range',
  },
  ...
  tabs: {
    ...
    skipped: 'Skipped',
    saved: 'Saved',
    monthSettled: 'Month bill marked as settled',
    today: 'Today',
    offSkipped: 'Off / Skipped',
    totalPayable: 'Total Payable Amount',
    payFromWallet: 'Pay from Wallet',
    expenseCategory: 'Expense Category',
    confirmSettle: 'Confirm Settlement & Record Expense',
    thisMonth: 'this month',
    activeSubs: 'active',
    choosePreset: 'Or Choose a Quick Preset',
    presetMess: 'Mess (Lunch & Dinner)',
    presetMilk: 'Daily Milk',
    presetWater: 'Water Can Delivery',
    presetMessLabel: 'Mess (Lunch & Dinner)',
    presetMilkLabel: 'Daily Milk',
    presetWaterLabel: 'Water Cans',
    ...
    slotDinner: 'Dinner',
    tabName: 'Tab Name',
    tabNamePlaceholder: 'e.g. Royal Mess, City Dairy Milk',
    unitLabel: 'Unit Name',
    unitLabelPlaceholder: 'e.g. tiffin, liter, meal',
    separateSlots: 'Daily Sub-Slots',
    separateSlotsDesc: 'Separate tracking for Lunch & Dinner or Morning & Evening',
    slotName: 'Slot',
    addSlot: 'Add Slot',
    presets: {
  ...
  wallets: {
    ...
    title: 'Wallets',
    noMatchFilter: 'No wallets match the selected filter',
  ...
  people: {
    ...
    phonePlaceholder: 'Optional notes or contact info',
    descPlaceholder: 'e.g. Dinner share, Rent split',
    repaymentDate: 'Expected Repayment Date',
    dueLabel: 'Due',
    paidSoFar: 'Paid so far',
    ofTotal: 'of',
    partialPay: 'Record Payment',
    originalAmount: 'Original Amount',
    remaining: 'Remaining',
    payAmount: 'Payment Amount',
    autoSettled: 'Remaining will be 0 — entry will be marked as Settled automatically',
    confirmPay: 'Confirm Payment',
    settleAllConfirm: 'Mark all open debts and loans with this person as settled?',
  ...
  recurring: {
    ...
    ruleName: 'Rule Name',
    ruleNamePlaceholder: 'e.g. Netflix Subscription, Apartment Rent',
    notePlaceholder: 'e.g. Family 4K plan, Direct deposit',
